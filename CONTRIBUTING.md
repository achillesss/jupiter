...
We use [GitHub Issues](https://github.com/achillesss/jupiter/issues) and [Pull Requests](https://github.com/achillesss/jupiter/pulls) for trackers.

If you find a typo in a document, find a bug in code, or want new features, or want to give suggestions,
you can [open an issue on GitHub](https://github.com/achillesss/jupiter/issues/new) to report it.
