...
PKG := "github.com/achillesss/jupiter"
...
demo.build: ## Build jupiter Demo
	@JUPITER_MODE=dev go build -ldflags  "-X github.com/achillesss/jupiter/initialize.AppName=hello" example/all/cmd/demo/main.go
